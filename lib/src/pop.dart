...
class Pop {
  ...
  IconData get fahrenheit => IconData(0xe932, fontFamily: _fontFamily);
  IconData get humidityNone => IconData(0xe934, fontFamily: _fontFamily);
  IconData get mergeVertical => IconData(0xe936, fontFamily: _fontFamily);
  ...
  IconData get emptyClipboard => IconData(0xe946, fontFamily: _fontFamily);
  IconData get bookmark => IconData(0xe948, fontFamily: _fontFamily);
  IconData get userCircleSingle => IconData(0xe94a, fontFamily: _fontFamily);
  IconData get shuffle => IconData(0xe94c, fontFamily: _fontFamily);
  IconData get cloud => IconData(0xe94e, fontFamily: _fontFamily);
  IconData get login1 => IconData(0xe950, fontFamily: _fontFamily);
  IconData get logout1 => IconData(0xe952, fontFamily: _fontFamily);
  IconData get scanner => IconData(0xe954, fontFamily: _fontFamily);
  IconData get pageSetting => IconData(0xe956, fontFamily: _fontFamily);
  IconData get newBadgeHighlight => IconData(0xe959, fontFamily: _fontFamily);
  IconData get voiceScan2 => IconData(0xe95b, fontFamily: _fontFamily);
  IconData get rotateLeft => IconData(0xe95d, fontFamily: _fontFamily);
  IconData get bellNotification => IconData(0xe95f, fontFamily: _fontFamily);
  IconData get autoCorrectionCheck => IconData(0xe961, fontFamily: _fontFamily);
  IconData get faceScan1 => IconData(0xe963, fontFamily: _fontFamily);
  IconData get horizontalSlider2 => IconData(0xe965, fontFamily: _fontFamily);
  IconData get dislikeCircle => IconData(0xe969, fontFamily: _fontFamily);
  IconData get layers1 => IconData(0xe96b, fontFamily: _fontFamily);
  IconData get alignBack1 => IconData(0xe96d, fontFamily: _fontFamily);
  ...
  IconData get dCoordinateAxis => IconData(0xe981, fontFamily: _fontFamily);
  IconData get arrowExpand => IconData(0xe983, fontFamily: _fontFamily);
  ...
  IconData get userFeedbackHeart => IconData(0xe9a8, fontFamily: _fontFamily);
  IconData get fileBookmark => IconData(0xe9aa, fontFamily: _fontFamily);
  IconData get fullScreenOsx => IconData(0xe9ac, fontFamily: _fontFamily);
  ...
  IconData get customerSupport5 => IconData(0xe9bf, fontFamily: _fontFamily);
  IconData get alignTop1 => IconData(0xe9c2, fontFamily: _fontFamily);
  IconData get dRotateYAxis => IconData(0xe9c5, fontFamily: _fontFamily);
  IconData get crown => IconData(0xe9c7, fontFamily: _fontFamily);
  IconData get shield2 => IconData(0xe9c9, fontFamily: _fontFamily);
  IconData get searchCategory => IconData(0xe9cb, fontFamily: _fontFamily);
  IconData get openUmbrella => IconData(0xe9ce, fontFamily: _fontFamily);
  ...
  IconData get lightbulb => IconData(0xe9de, fontFamily: _fontFamily);
  IconData get textStyle => IconData(0xe9e0, fontFamily: _fontFamily);
  IconData get dashboard3 => IconData(0xe9e2, fontFamily: _fontFamily);
  IconData get featherPen => IconData(0xe9e5, fontFamily: _fontFamily);
  IconData get customerSupport7 => IconData(0xe9e7, fontFamily: _fontFamily);
  IconData get shield1 => IconData(0xe9e9, fontFamily: _fontFamily);
  IconData get userFullBody => IconData(0xe9eb, fontFamily: _fontFamily);
  IconData get snooze => IconData(0xe9ee, fontFamily: _fontFamily);
  IconData get hierarchy16 => IconData(0xe9f0, fontFamily: _fontFamily);
  IconData get arrowRoadmap => IconData(0xe9f3, fontFamily: _fontFamily);
  IconData get home2 => IconData(0xe9f7, fontFamily: _fontFamily);
  IconData get userQueenCrown => IconData(0xe9f9, fontFamily: _fontFamily);
  IconData get colorPicker => IconData(0xe9fc, fontFamily: _fontFamily);
  IconData get textSquare => IconData(0xe9fe, fontFamily: _fontFamily);
  IconData get penTool => IconData(0xea00, fontFamily: _fontFamily);
  IconData get whiteBoard => IconData(0xea02, fontFamily: _fontFamily);
  IconData get insertCenterLeft1 => IconData(0xea04, fontFamily: _fontFamily);
  IconData get trophy => IconData(0xea06, fontFamily: _fontFamily);
  IconData get wrenchHand => IconData(0xea08, fontFamily: _fontFamily);
  IconData get layoutWindow1 => IconData(0xea0a, fontFamily: _fontFamily);
  IconData get uploadBox1 => IconData(0xea0c, fontFamily: _fontFamily);
  IconData get cube => IconData(0xea0e, fontFamily: _fontFamily);
  IconData get newFile => IconData(0xea10, fontFamily: _fontFamily);
  IconData get arrowCursorMove => IconData(0xea12, fontFamily: _fontFamily);
  IconData get thermometer => IconData(0xea14, fontFamily: _fontFamily);
  ...
  IconData get linkChain => IconData(0xea3c, fontFamily: _fontFamily);
  IconData get inputBox => IconData(0xea3e, fontFamily: _fontFamily);
  IconData get colorSwatches => IconData(0xea40, fontFamily: _fontFamily);
  IconData get invisible1 => IconData(0xea43, fontFamily: _fontFamily);
  IconData get shareLink => IconData(0xea46, fontFamily: _fontFamily);
  IconData get dRotate1 => IconData(0xea4a, fontFamily: _fontFamily);
  IconData get starBadge => IconData(0xea4c, fontFamily: _fontFamily);
  IconData get arrowCursorClick2 => IconData(0xea4e, fontFamily: _fontFamily);
  IconData get downloadBox1 => IconData(0xea50, fontFamily: _fontFamily);
  IconData get fingerprint1 => IconData(0xea52, fontFamily: _fontFamily);
  IconData get showLayer => IconData(0xea54, fontFamily: _fontFamily);
  IconData get zoomOutGesture => IconData(0xea56, fontFamily: _fontFamily);
  IconData get expandCropResize => IconData(0xea58, fontFamily: _fontFamily);
  IconData get helpChat1 => IconData(0xea5a, fontFamily: _fontFamily);
  ...
  IconData get darkDislayMode => IconData(0xea6b, fontFamily: _fontFamily);
  IconData get waveSignalCircle => IconData(0xea6d, fontFamily: _fontFamily);
  IconData get mergePdf => IconData(0xea6f, fontFamily: _fontFamily);
  IconData get keyFrame => IconData(0xea71, fontFamily: _fontFamily);
  IconData get smallCaps => IconData(0xea73, fontFamily: _fontFamily);
  IconData get copy2 => IconData(0xea75, fontFamily: _fontFamily);
  IconData get hierarchy1 => IconData(0xea77, fontFamily: _fontFamily);
  IconData get padlockSquare1 => IconData(0xea7a, fontFamily: _fontFamily);
  IconData get pen1 => IconData(0xea7c, fontFamily: _fontFamily);
  IconData get alignSelection => IconData(0xea7e, fontFamily: _fontFamily);
  IconData get screenshot => IconData(0xea80, fontFamily: _fontFamily);
  IconData get typewriter => IconData(0xea82, fontFamily: _fontFamily);
  IconData get pin1 => IconData(0xea84, fontFamily: _fontFamily);
  ...
  IconData get padlockSquare2 => IconData(0xeaad, fontFamily: _fontFamily);
  IconData get cog => IconData(0xeaaf, fontFamily: _fontFamily);
  IconData get scissors => IconData(0xeab1, fontFamily: _fontFamily);
  IconData get archiveBox => IconData(0xeab4, fontFamily: _fontFamily);
  IconData get userIdentifierCard => IconData(0xeab6, fontFamily: _fontFamily);
  IconData get projectorBoard => IconData(0xeab8, fontFamily: _fontFamily);
  IconData get zoomOut => IconData(0xeaba, fontFamily: _fontFamily);
  IconData get incorrectPassword => IconData(0xeabc, fontFamily: _fontFamily);
  IconData get notepadText => IconData(0xeabe, fontFamily: _fontFamily);
  IconData get polygonalLassoTool => IconData(0xeac0, fontFamily: _fontFamily);
  IconData get sigma => IconData(0xeac3, fontFamily: _fontFamily);
  IconData get sofa => IconData(0xeac5, fontFamily: _fontFamily);
  IconData get coinShare => IconData(0xeac7, fontFamily: _fontFamily);
  IconData get gift2 => IconData(0xeaca, fontFamily: _fontFamily);
  IconData get building1 => IconData(0xeacc, fontFamily: _fontFamily);
  IconData get tallHat => IconData(0xeace, fontFamily: _fontFamily);
  ...
  IconData get securityUmbrella => IconData(0xeadf, fontFamily: _fontFamily);
  IconData get qrCode => IconData(0xeae1, fontFamily: _fontFamily);
  IconData get table => IconData(0xeae3, fontFamily: _fontFamily);
  IconData get piggyBank => IconData(0xeae5, fontFamily: _fontFamily);
  IconData get shoppingBagHandBag2 => IconData(0xeae7, fontFamily: _fontFamily);
  IconData get bag => IconData(0xeae9, fontFamily: _fontFamily);
  IconData get diamond1 => IconData(0xeaeb, fontFamily: _fontFamily);
  IconData get dollarIncrease => IconData(0xeaed, fontFamily: _fontFamily);
  IconData get treasureChest => IconData(0xeaef, fontFamily: _fontFamily);
  IconData get cashingCheck => IconData(0xeaf1, fontFamily: _fontFamily);
  ...
  IconData get graphDot => IconData(0xeb01, fontFamily: _fontFamily);
  IconData get ball => IconData(0xeb05, fontFamily: _fontFamily);
  IconData get searchArrowIncrease => IconData(0xeb07, fontFamily: _fontFamily);
  IconData get criticalThinking2 => IconData(0xeb09, fontFamily: _fontFamily);
  ...
  IconData get safeVault => IconData(0xeb19, fontFamily: _fontFamily);
  IconData get bill4 => IconData(0xeb1b, fontFamily: _fontFamily);
  IconData get target => IconData(0xeb1d, fontFamily: _fontFamily);
  IconData get shoppingBasket2 => IconData(0xeb1f, fontFamily: _fontFamily);
  IconData get receipt => IconData(0xeb21, fontFamily: _fontFamily);
  IconData get pieChart => IconData(0xeb23, fontFamily: _fontFamily);
  IconData get incomingCall => IconData(0xeb25, fontFamily: _fontFamily);
  ...
  IconData get browserBookmark => IconData(0xeb58, fontFamily: _fontFamily);
  IconData get codeAnalysis => IconData(0xeb5a, fontFamily: _fontFamily);
  IconData get steps2 => IconData(0xeb5c, fontFamily: _fontFamily);
  IconData get cloudDownload => IconData(0xeb60, fontFamily: _fontFamily);
  IconData get modulePuzzle2 => IconData(0xeb62, fontFamily: _fontFamily);
  IconData get fileCode1 => IconData(0xeb64, fontFamily: _fontFamily);
  IconData get bugAntivirusShield => IconData(0xeb67, fontFamily: _fontFamily);
  IconData get codeMonitor1 => IconData(0xeb69, fontFamily: _fontFamily);
  IconData get script2 => IconData(0xeb6b, fontFamily: _fontFamily);
  IconData get incognitoMode => IconData(0xeb6d, fontFamily: _fontFamily);
  IconData get cloudDataTransfer => IconData(0xeb6f, fontFamily: _fontFamily);
  IconData get cloudOff => IconData(0xeb71, fontFamily: _fontFamily);
  IconData get screenBroadcast => IconData(0xeb73, fontFamily: _fontFamily);
  IconData get threatPhone => IconData(0xeb76, fontFamily: _fontFamily);
  IconData get landscapeLock => IconData(0xeb79, fontFamily: _fontFamily);
  IconData get film => IconData(0xeb7b, fontFamily: _fontFamily);
  IconData get imageLocation => IconData(0xeb7d, fontFamily: _fontFamily);
  ...
  IconData get polaroidFour => IconData(0xeb8e, fontFamily: _fontFamily);
  IconData get gallery => IconData(0xeb93, fontFamily: _fontFamily);
  IconData get flashOff => IconData(0xeb95, fontFamily: _fontFamily);
  IconData get portraitLock => IconData(0xeb97, fontFamily: _fontFamily);
  IconData get camera1 => IconData(0xeb99, fontFamily: _fontFamily);
  IconData get flashWarning => IconData(0xeb9b, fontFamily: _fontFamily);
  IconData get focusFrame => IconData(0xeb9e, fontFamily: _fontFamily);
  IconData get packageDimension => IconData(0xeba0, fontFamily: _fontFamily);
  IconData get shippingBox2 => IconData(0xeba2, fontFamily: _fontFamily);
  IconData get transferTruckTime => IconData(0xeba4, fontFamily: _fontFamily);
  IconData get warehouse1 => IconData(0xeba7, fontFamily: _fontFamily);
  IconData get fragile => IconData(0xeba9, fontFamily: _fontFamily);
  IconData get artistSong => IconData(0xebab, fontFamily: _fontFamily);
  IconData get buttonMoveCircle => IconData(0xebae, fontFamily: _fontFamily);
  IconData get volumeLevelHigh => IconData(0xebb0, fontFamily: _fontFamily);
  IconData get balloon => IconData(0xebb2, fontFamily: _fontFamily);
  IconData get tuneAdjustVolume => IconData(0xebb4, fontFamily: _fontFamily);
  IconData get cameraVideo => IconData(0xebb6, fontFamily: _fontFamily);
  IconData get speaker1 => IconData(0xebb8, fontFamily: _fontFamily);
  IconData get musicEqualizer => IconData(0xebba, fontFamily: _fontFamily);
  IconData get addToPlaylist => IconData(0xebbc, fontFamily: _fontFamily);
  IconData get buttonRecord1 => IconData(0xebbf, fontFamily: _fontFamily);
  IconData get gambling => IconData(0xebc1, fontFamily: _fontFamily);
  IconData get buttonPower1 => IconData(0xebc4, fontFamily: _fontFamily);
  IconData get chessKing => IconData(0xebc6, fontFamily: _fontFamily);
  IconData get buttonPauseCircle => IconData(0xebc8, fontFamily: _fontFamily);
  IconData get watchtowerCastle => IconData(0xebca, fontFamily: _fontFamily);
  IconData get tapeCassetteRecord => IconData(0xebcc, fontFamily: _fontFamily);
  IconData get repeatSingle => IconData(0xebce, fontFamily: _fontFamily);
  IconData get esports => IconData(0xebd0, fontFamily: _fontFamily);
  IconData get playList4 => IconData(0xebd2, fontFamily: _fontFamily);
  IconData get musicNoteCircle => IconData(0xebd4, fontFamily: _fontFamily);
  IconData get volumeMute => IconData(0xebd6, fontFamily: _fontFamily);
  IconData get playList6 => IconData(0xebd8, fontFamily: _fontFamily);
  ...
  IconData get friedEggBreakfast => IconData(0xebef, fontFamily: _fontFamily);
  IconData get saladVegetableDiet => IconData(0xebf1, fontFamily: _fontFamily);
  IconData get chefToqueHat => IconData(0xebf4, fontFamily: _fontFamily);
  IconData get toaster => IconData(0xebf6, fontFamily: _fontFamily);
  IconData get cocktail => IconData(0xebf9, fontFamily: _fontFamily);
  IconData get cakeSlice => IconData(0xebfb, fontFamily: _fontFamily);
  IconData get allergensFish => IconData(0xebfe, fontFamily: _fontFamily);
  ...
  IconData get campingTent => IconData(0xec59, fontFamily: _fontFamily);
  IconData get stairs1 => IconData(0xec5b, fontFamily: _fontFamily);
  IconData get toiletManWoman1 => IconData(0xec5d, fontFamily: _fontFamily);
  IconData get carTaxi1 => IconData(0xec62, fontFamily: _fontFamily);
  IconData get airship => IconData(0xec64, fontFamily: _fontFamily);
  IconData get intersexSymbol => IconData(0xec67, fontFamily: _fontFamily);
  IconData get petPaw => IconData(0xec69, fontFamily: _fontFamily);
  IconData get cityHall => IconData(0xec6b, fontFamily: _fontFamily);
  IconData get toiletSignMan => IconData(0xec6d, fontFamily: _fontFamily);
  IconData get bicycleBike => IconData(0xec70, fontFamily: _fontFamily);
  IconData get mapLocation => IconData(0xec73, fontFamily: _fontFamily);
  IconData get suitcaseRolling => IconData(0xec76, fontFamily: _fontFamily);
  IconData get toiletMan => IconData(0xec78, fontFamily: _fontFamily);
  IconData get visualBlind1 => IconData(0xec7b, fontFamily: _fontFamily);
  IconData get departureTime => IconData(0xec7d, fontFamily: _fontFamily);
  IconData get wheelchair1 => IconData(0xec80, fontFamily: _fontFamily);
  IconData get anchor => IconData(0xec82, fontFamily: _fontFamily);
  IconData get iron => IconData(0xec84, fontFamily: _fontFamily);
  IconData get streetRoad => IconData(0xec86, fontFamily: _fontFamily);
  ...
  IconData get surveillanceCamera => IconData(0xec96, fontFamily: _fontFamily);
  IconData get bell => IconData(0xec98, fontFamily: _fontFamily);
  IconData get locationTarget2 => IconData(0xec9a, fontFamily: _fontFamily);
  IconData get airportPlane => IconData(0xec9c, fontFamily: _fontFamily);
  IconData get schoolBusSide => IconData(0xec9e, fontFamily: _fontFamily);
  IconData get campfire => IconData(0xeca0, fontFamily: _fontFamily);
  ...
  IconData get leftClick => IconData(0xeccb, fontFamily: _fontFamily);
  IconData get bluetoothDisabled => IconData(0xeccd, fontFamily: _fontFamily);
  ...
  IconData get returnSquare2 => IconData(0xecf5, fontFamily: _fontFamily);
  IconData get webcam => IconData(0xecf7, fontFamily: _fontFamily);
  ...
  IconData get printerWireless => IconData(0xed07, fontFamily: _fontFamily);
  IconData get keyboard => IconData(0xed0a, fontFamily: _fontFamily);
  IconData get floppyDisk => IconData(0xed0c, fontFamily: _fontFamily);
  IconData get database => IconData(0xed0e, fontFamily: _fontFamily);
  IconData get batteryMedium1 => IconData(0xed10, fontFamily: _fontFamily);
  IconData get controllerWireless => IconData(0xed12, fontFamily: _fontFamily);
  IconData get controllerStick => IconData(0xed14, fontFamily: _fontFamily);
  IconData get vpnConnection => IconData(0xed16, fontFamily: _fontFamily);
  IconData get watch2 => IconData(0xed18, fontFamily: _fontFamily);
  IconData get computerChip1 => IconData(0xed1a, fontFamily: _fontFamily);
  IconData get dribbleLogo => IconData(0xed1c, fontFamily: _fontFamily);
  IconData get tinderLogo => IconData(0xed1e, fontFamily: _fontFamily);
  IconData get recycle1 => IconData(0xed20, fontFamily: _fontFamily);
  IconData get dog1 => IconData(0xed23, fontFamily: _fontFamily);
  IconData get rocket => IconData(0xed25, fontFamily: _fontFamily);
  IconData get tidalWave => IconData(0xed27, fontFamily: _fontFamily);
  IconData get alien => IconData(0xed29, fontFamily: _fontFamily);
  IconData get recycleBin => IconData(0xed2b, fontFamily: _fontFamily);
  IconData get flower => IconData(0xed2d, fontFamily: _fontFamily);
  IconData get erlenmeyerFlask => IconData(0xed2f, fontFamily: _fontFamily);
  IconData get cat2 => IconData(0xed31, fontFamily: _fontFamily);
  IconData get galaxy2 => IconData(0xed33, fontFamily: _fontFamily);
  IconData get reducedInequalities => IconData(0xed35, fontFamily: _fontFamily);
